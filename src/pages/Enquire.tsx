                      ...
                      <div>
                        ...
                        <div className="relative">
                          <input
                            ref={dateRef}
                            type="date"
                            className="mt-1 w-full box-border border rounded px-3 py-3 pr-12 text-sm bg-white appearance-none focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-[#00C5C5]"
                            aria-label="Tour start date"
                          />
                          <svg
                            onClick={() => (dateRef.current as any)?.showPicker?.()}
                            className="absolute top-1/2 right-3 transform -translate-y-1/2 h-5 w-5 text-gray-400 cursor-pointer"
